...
RSpec.describe 'check_board(numbers, board) :' do
  ...
  it ' checking board (board wins)' do
    ...
    check = Task004.check_board(puzzle_input[0][0..numbers_drawn], puzzle_input[1][board_number])
...
RSpec.describe 'find_winners(puzzle_input) :' do
  ...
  it ' finding winner board ' do
    results = Task004.find_winners(puzzle_input)
...
RSpec.describe 'sum_unmarked_numbers(puzzle_input, results) :' do
  ...
  it ' count sum of not drown numbers' do
    ...
    sum = Task004.sum_unmarked_numbers(puzzle_input, results)
...
RSpec.describe 'calculate_answer(puzzle_input) :' do
  ...
  it ' calculate task answer' do
    answer = Task004.calculate_answer(puzzle_input)
