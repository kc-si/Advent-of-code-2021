...
RSpec.describe 'check_board(numbers, board) :' do
  ...
  it ' checking board (board wins)' do
    ...
    check = Task004a.check_board(puzzle_input[0][0..numbers_drawn], puzzle_input[1][board_number])
...
RSpec.describe 'find_winners(puzzle_input) :' do
  ...
  it ' finding winner board ' do
    results = Task004a.find_winners(puzzle_input)

    expect(true).to eq(results[:winners] == [2, 0, 1] && results[:numbers_drawn] == 14)
  end
end
...
RSpec.describe 'sum_unmarked_numbers(puzzle_input, results) :' do
  ...
  it ' count sum of not drown numbers' do
    results = {winners: [2, 0, 1], numbers_drawn: 14}

    sum = Task004a.sum_unmarked_numbers(puzzle_input, results)

    expect(sum).to eq(148)
  end
end
